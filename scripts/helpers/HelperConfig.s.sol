...
contract HelperConfig is Script {
    ...
    constructor() {
        ...
        if (activeNetworkConfig.chainId == 0) {
    ...
    // Note: These are for future mainnet deployments
    function getEthMainnetConfig() public pure returns (NetworkConfig memory) {
        return NetworkConfig({
            usdcToken: 0xA0b86a33E6C05A8f23eE91d3a9d5B0a04f1ECD4e, // Mainnet USDC
    ...
    function getPolygonMainnetConfig() public pure returns (NetworkConfig memory) {
        return NetworkConfig({
            usdcToken: 0x2791Bca1f2de4661ED88A30A58C5ba1Ee28F2DAA, // Polygon USDC
            usdtToken: 0xc2132D05D31c914a87C6611C10748AEb04B58E8F,  // Polygon USDT
            networkName: "polygon",
    ...
    function getBaseMainnetConfig() public pure returns (NetworkConfig memory) {
        return NetworkConfig({
            ...
            usdtToken: address(0), // No native USDT on Base mainnet yet
            networkName: "base",
